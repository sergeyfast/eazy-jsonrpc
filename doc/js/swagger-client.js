...
Operation.prototype.execute = function(arg1, arg2, arg3, arg4, parent) {
  ...
  //todo move to "json-rpc 2.0" option
  requestUrl = requestUrl.substr(1).replace( "/", ".");
  var url = this.scheme + '://' + this.host + this.basePath;
  var jsonParams = args.body ? args.body : '{}';
  args.body = '{"jsonrpc":"2.0","method":"' + requestUrl + '","id":1,"params":' + jsonParams + '}';
